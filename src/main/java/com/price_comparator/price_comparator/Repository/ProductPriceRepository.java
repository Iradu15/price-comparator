...
public interface ProductPriceRepository extends JpaRepository<ProductPrice, Long> {
    ...
    @Query("""
            ...
            """)
    Optional<ProductPrice> findCurrentPrice(@Param("product") Product product, @Param("store") Store store, @Param(
    ...
    @Query("""
            ...
            ORDER BY p.price
            """)
    Optional<List<Store>> findStoresHavingProduct(@Param("product") Product product,
    ...
    Optional<List<ProductPrice>> findOverlappingMappings(@Param("product") Product product,
