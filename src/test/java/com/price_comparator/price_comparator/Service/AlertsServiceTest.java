...
public class AlertsServiceTest extends AbstractBaseTest {
    ...
    void testCheckAlertsSingleStoreNoDiscount(){
        ...
        ProductPrice productPrice = setUpProductPrice(store, product, "ron", 12.5, currentDate.minusDays(1), null);
        Alert alert1 = setUpAlert(product, 13.0);
        Alert alert2 = setUpAlert(product, 8.0);
    ...
    void testCheckAlertsSingleStoreDiscount(){
        ...
        Store store = setUpStoreEntity("lidl");
        Product product = setUpProduct("P001", "lapte", "lactate", "zuzu", 1.0, "l");
        ProductPrice productPrice = setUpProductPrice(store, product, "ron", 20.0, currentDate.minusDays(1), null);
    ...
    void testCheckAlertsNoStoresHavingProduct(){
        ...
        ProductPrice productPrice = setUpProductPrice(store, product, "ron", 20.0, currentDate.minusDays(1), null);
        ProductPrice productPrice2 = setUpProductPrice(store, product2, "ron", 40.0, currentDate.minusDays(1), null);
        Alert alert1 = setUpAlert(product, 19.0);
        Alert alert2 = setUpAlert(product2, 39.0);
    ...
    void testCheckAlertsOneStoreHavingBelowPrice(){
        ...
        Product product = setUpProduct("P001", "lapte", "lactate", "zuzu", 1.0, "l");
        ProductPrice productPrice = setUpProductPrice(store, product, "ron", 20.0, currentDate.minusDays(1), null);
        ProductPrice productPrice2 = setUpProductPrice(store2, product, "ron", 25.0, currentDate.minusDays(1), null);
        Alert alert = setUpAlert(product, 21.0);
